...
<md:AssociatedOrg organizationID="Prime Video Partner Alias"role="licensor"></md:AssociatedOrg>
...
<md:DisplayString language="{{$data['CompanyDisplayCredit']['DisplayString']['@language']}}">{{$data['CompanyDisplayCredit']['DisplayString']['value']}}</md:DisplayString>
</mdmec:CompanyDisplayCredit>
</mdmec:CoreMetadata>
